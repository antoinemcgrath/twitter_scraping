...
# Follow up with 2nd script to enter tweets to DB: python3 test_mongo_metadata.py
...
for another_user in all_data:
    ...
    print(str("%.0f" % ((total_t)/60)) + " minutes taken to add " + str(len(data_to_write)) + " tweets to the file of " + str(name) )
    driver.close()
